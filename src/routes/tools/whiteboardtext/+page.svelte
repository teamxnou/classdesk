...
<div class="flex h-screen w-screen flex-col gap-5 bg-neutral-100 p-12">
  <div class="flex w-full items-center justify-between gap-10">
    ...
    <label>
      ...
      <div
        class="cursor-pointer rounded-lg p-3 transition-[color] duration-150 hover:bg-neutral-200 peer-checked:text-blue-500 peer-checked:hover:bg-blue-100 peer-checked:hover:text-blue-600"
      >
